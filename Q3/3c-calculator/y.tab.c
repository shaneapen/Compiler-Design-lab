...
#line 42 "cal.y" /* yacc.c:1906  */
 
  
//driver code 
void main() 
{ 
   printf("\nEnter Any Arithmetic Expression which  can have operation,Addition,Subtraction,Multiplication,Divison,Modulus and Round brackets: "); 
